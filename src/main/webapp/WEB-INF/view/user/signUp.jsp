...
<body>
	...
	<form action="/user/sign-up" method="post">
		...
		<div id="verificationSection" style="display: none;">
			...
			<input type="text" id="authCode" name="code" required placeholder="인증 코드를 입력하세요">
...
&redirect_uri=http://localhost:8080/user/kakao">
		<img alt="카카오로그인이미지" src="/images/kakaologin.png" style="width: 50px; height: auto;">
	</a>
	<a href="https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=VV02L4roYlvMO2qxf3n7&state=STATE_STRING&redirect_uri=http://localhost:8080/user/naver">
		<img alt="네이버로그인이미지" src="/images/naverlogin.png" style="width: 50px; height: auto;">
	</a>
...
>>>>>>> 3aa0b473c073f780f21faf2c71874a4fd19f44bc
