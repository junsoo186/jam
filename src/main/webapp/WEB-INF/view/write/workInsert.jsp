...
<body>
	...
	<form action="workInsert" method="post" onsubmit="return prepareFormForSubmit()">
		...
		<br> <br> <label for="author">저자:</label> <input type="text" id="author" name="author" value="테스트 저자" required /><br> <br> <label for="serialDay">연재
			...
			value="화요일"> <label for="tuesday">화요일</label><br> <input type="radio" id="wednesday" name="serialDay" value="수요일"> <label for="wednesday">수요일</label><br>
		<input type="radio" id="thursday" name="serialDay" value="목요일"> <label for="thursday">목요일</label><br> <input type="radio" id="friday" name="serialDay" value="금요일">
		<label for="friday">금요일</label><br> <input type="radio" id="saturday" name="serialDay" value="토요일"> <label for="saturday">토요일</label><br> <input type="radio"
			id="sunday" name="serialDay" value="일요일"> <label for="sunday">일요일</label><br> <input type="radio" id="irregular" name="serialDay" value="비 정기 연재"> <label
