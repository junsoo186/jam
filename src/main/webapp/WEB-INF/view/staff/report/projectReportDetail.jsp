<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            ...
            <head>
                <meta charset="UTF-8">
                <title>프로젝트 신고 상세보기</title>
            </head>

            <body>
                <h2 class="modal--h2">프로젝트 신고 상세보기</h2>
                <p><b>프로젝트 ID:</b> ${report.projectId}</p>
                ...
                <p><b>프로젝트의 누적 신고 횟수:</b> ${report.projectReportCount}</p>
                ...
                <c:if test="${report.processing == 'N'}">
                    <form id="reportProcessForm" method="POST" action="/staff/processReport">
                        <label for="reportId">프로젝트 제목 :</label>
                        <input type="text" id="reportId" name="reportId" value="${report.projectTitle}" readonly>
