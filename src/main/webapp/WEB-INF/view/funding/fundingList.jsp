        ...
        <div class="project-container">
            <c:forEach items="${projectList}" var="project" varStatus="status">
                <form action="/funding/fundingDetail" method="get" class="project-form">
                    <div class="project-card" data-goal="${project.goal}" data-current="${project.totalAmount}" data-end-date="${project.dateEnd}">
                        ...
                        <div class="project-info">
                            ...
                            <div class="progress-info">
                                <span class="progress-percentage" id="progress-percentage-${status.index}"></span>
                                <span class="progress-funding" id="progress-funding-${status.index}"></span>
                            </div>
                            <div class="progress-bar-container">
                                <div class="progress-bar" id="progress-bar-${status.index}"></div>
                            </div>
