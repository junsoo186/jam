document.getElementById('finalCheckoutButton').addEventListener('click', function () {
    ...
    const cartItems = /* 기존의 장바구니 아이템 JSON */;
    ...
    fetch('/funding/checkout', {
        ...
        .then(result => {
            if (result.success) {
                alert('결제가 완료되었습니다!');
                window.location.href = '/funding/confirmation';
            } else {
