document.addEventListener('DOMContentLoaded', function () {
    ...
    const bookId = urlParams.get('bookId'); // URL에서 bookId 파라미터 가져옴
    ...
    addRewardBtn.addEventListener('click', function () {
        ...
        <div class="form--group--area">
            ...
            <input type="number" id="rewardQuantity-${rewardIndex}" name="rewards[${rewardIndex}].quantity" class="form--input--number" min="1" placeholder="리워드 수량을 입력하세요" required>
        </div>
    ...
    fundingFormElement.addEventListener('submit', function (event) {
        ...
        // URL에서 추출한 bookId를 FormData에 추가
        if (bookId) {
